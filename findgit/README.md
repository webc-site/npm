...
- [@1-/findgit : Find Git repository root directory upward](#1-findgit-find-git-repository-root-directory-upward)
...
- [@1-/findgit : 向上寻找 Git 仓库根目录](#1-findgit-向上寻找-git-仓库根目录)
  - [目录](#目录)
  - [功能介绍](#功能介绍)
  - [使用演示](#使用演示)
  - [设计思路](#设计思路)
